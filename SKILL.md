...
- For AI Intent Canvas rationale, three canvas levels, intent-vs-reality validation graph, observability feedback loops, MCP/BYO-key direction, and true tool-calling agent roadmap, read `references/source-materials/tutorials/CAMPFIRE-INTRODUCTION-AI-INTENT-CANVAS.md`.
